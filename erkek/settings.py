"""
Django settings for erkek project.
...
INSTALLED_APPS = [
    ...
    'isimler.apps.IsimlerConfig',
    'tinymce',
    "django.contrib.sitemaps",
    'isimler.templatetags.custom_filters',
...
WSGI_APPLICATION = "erkek.wsgi.application"
...
#
#STATIC_URL = '/static/'
#STATIC_ROOT = os.path.join(BASE_DIR, 'isimler', 'static')  # Statik dosyalar için farklı bir dizin
#
#STATICFILES_DIRS = [
...
#
#MEDIA_URL = '/media/'
#MEDIA_ROOT = os.path.join(BASE_DIR, 'isimler', 'static', 'media')
#
...
if DEBUG:
    ...
    DEFAULT_FILE_STORAGE = 'erkek.custom_storages.MediaStorage'
